...
const Home = ({ onStart }) => {
  ...
  const doodles = useMemo(() => [
    // Existing ones
    { type: 'text', content: 'class is boring...', top: '5%', left: '10%', rotation: -12 },
    { type: 'cloud', content: '', top: '4%', right: '25%', rotation: 5 },
    ...
    { type: 'arrow', top: '40%', left: '2%', rotation: 160 },
    ...
    // New ones
    { type: 'heart', top: '2%', left: '20%', rotation: 10, color: '#ff758c', opacity: 0.8 },
    { type: 'star', bottom: '25%', right: '2%', rotation: -15, color: '#ffd166', opacity: 0.9 },
    { type: 'coffee', top: '75%', left: '2%', rotation: 0, opacity: 0.3 },
    { type: 'text', content: 'why am I here?', top: '45%', left: '10%', rotation: -5, opacity: 0.5 },
    ...
    { type: 'text', content: 'ZZZzz...', top: '5%', right: '40%', rotation: -10, opacity: 0.4 },
    ...
    { type: 'text', content: 'No mistakes, only doodles.', top: '50%', right: '20%', rotation: 3, opacity: 0.4 },
    { type: 'star', top: '10%', left: '40%', rotation: 45, color: '#9bf6ff', opacity: 0.5 },
  ], []);

  const stickers = useMemo(() => [
    { text: 'A+ Effort', emoji: '⭐', bgColor: '#ffadad', top: '1%', left: '1%', rotation: -15 },
    { text: 'Boring!', emoji: '🥱', bgColor: '#ffd166', top: '1%', right: '1%', rotation: 10 },
    { text: 'Winner', emoji: '🏆', bgColor: '#9bf6ff', bottom: '6%', left: '6%', rotation: 5 },
    { text: 'Chaos', emoji: '🌀', bgColor: '#caffbf', bottom: '12%', right: '4%', rotation: -8 },
    { emoji: '🍕', bgColor: '#bdb2ff', top: '55%', left: '2%', rotation: 12 },
  ...
  return (
    <div className="min-h-screen notebook-paper paper-texture flex flex-col items-center justify-center overflow-hidden px-4">
      ...
      <div className="relative z-10 text-center max-w-4xl py-20">
        ...
        {/* Title Section with Sticky Notes Inline */}
        <div className="flex flex-col xl:flex-row items-center justify-center gap-8 xl:gap-20 mb-12 relative z-30">
          {/* Yellow Note (Left) */}
          <div className="relative order-2 xl:order-1">
            ...
            <StickyNote rotation={6} color="#fff59d">
              ...
              <ol className="text-xl space-y-1 text-left">
                <li>1. Overthink</li>
                <li>2. Overplay</li>
                <li>3. Regret 🙂</li>
              </ol>
          ...
          <div className="relative order-3">
            ...
            <StickyNote rotation={-4} color="#ffcfd2">
              ...
              <p className="mt-2 text-sm italic opacity-60">"just one more game..."</p>
            </StickyNote>
          </div>
        </div>
